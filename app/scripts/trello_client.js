(function () {
  var opts = {
    ...
    "key": "7717988a40f97ccbc0e2faf1414488a4"
  };
  ...
  wrapper = function (c, g, b) {
    ...
    f = {
      version: function () {
        ...
        d = k[0];
        a = k[1];
        b = {url: "" + y + d, type: c, data: {}, dataType: "json", success: k[2], error: k[3]};
        g.support.cors || (b.dataType =
          "jsonp", "GET" !== c && (b.type = "GET", g.extend(b.data, {_method: c})));
        m && (b.data.key = m);
        e && (b.data.token = e);
        ...
        if (this.authorized())return d(), n.hash = n.hash.replace(a, ""), "function" === typeof b.success ? b.success() : void 0;
    ...
    c.Trello = f;
    w = function (a) {
      return l + "/" + s + "/authorize?" + g.param(g.extend({response_type: "token", key: m}, a))
    };
    z = function (a) {
      var b, c, d;
      c = a[0];
    ...
    d = function (a) {
      var b;
      a.origin === l && (null != (b = a.source) && b.close(), e = null != a.data && 4 < a.data.length ? a.data : null, isReady("authorized", f.authorized()))
    };
    r = c.localStorage;
    null != r ? (x = function (a) {
      return r["trello_" + a]
  ...
  waitUntil = function (c, g) {
    return null != ready[c] ? g(ready[c]) : (null != deferred[c] ? deferred[c] : deferred[c] = []).push(g)
  };
  isReady = function (c, g) {
    var b, f, d, l;
    ready[c] = g;
    if (deferred[c])for (f = deferred[c], delete deferred[c], d = 0, l = f.length; d < l; d++)b = f[d], b(g)
  };
